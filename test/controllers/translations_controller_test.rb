...
class TranslationsControllerTest < ActionController::TestCase
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post :create, translation: { active: @translation.active, papa: @translation.papa, pontifice: @translation.pontifice }
    end
  ...
  test "should update translation" do
    patch :update, id: @translation, translation: { active: @translation.active, papa: @translation.papa, pontifice: @translation.pontifice }
    assert_redirected_to translation_path(assigns(:translation))
  end
